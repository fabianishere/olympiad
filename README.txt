...
You can use solution 2a by running "olympiad/tdrop.py" with Python without arguments. The program will read the direction and the position from a in.txt and write the results to out.txt.

Solution 2b use be tested by running "olympiad/tdrop.py" with Python with "b" as argument. ("$ python3 olympiad/tdrop.py b") You can then input a number through the standard input and the program will write the result to the standard output.
